                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('chapter.update',[$chapter->id])}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="{{$chapter->tieude}}" onkeyup="ChangeToSlug();" name="tieude" id="slug"
                            ...
                            <textarea name="noidung" id="noidung_chapter" class="form-control" rows="5" style="resize: none">{{$chapter->noidung}}</textarea> <br>
